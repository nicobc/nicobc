...
export const dimProducts: DimProduct[] = [
  { product_id: 1, product_name: 'Laptop Pro 15', category: 'Electronics', unit_price: 1200 },
  { product_id: 2, product_name: 'USB-C Hub', category: 'Electronics', unit_price: 45 },
  { product_id: 3, product_name: 'Wireless Earbuds', category: 'Electronics', unit_price: 89 },
  { product_id: 4, product_name: 'Power Drill', category: 'Tools', unit_price: 135 },
  { product_id: 5, product_name: 'Screwdriver Set', category: 'Tools', unit_price: 28 },
  { product_id: 6, product_name: 'Measuring Tape', category: 'Tools', unit_price: 12 },
  { product_id: 7, product_name: 'Olive Oil 1L', category: 'Food', unit_price: 8 },
  { product_id: 8, product_name: 'Canned Tomatoes', category: 'Food', unit_price: 3 },
  { product_id: 9, product_name: 'Pasta 500g', category: 'Food', unit_price: 2 },
  { product_id: 10, product_name: 'Winter Jacket', category: 'Clothing', unit_price: 180 },
  { product_id: 11, product_name: 'Running Shoes', category: 'Clothing', unit_price: 120 },
  { product_id: 12, product_name: 'Printer Paper', category: 'Office', unit_price: 15 },
];
...
export const fctOrderItems: FctOrderItem[] = [
  ...
  { order_id: 2, product_id: 4, quantity: 4 },
  { order_id: 3, product_id: 1, quantity: 6 },
  { order_id: 3, product_id: 5, quantity: 2 },
  { order_id: 4, product_id: 2, quantity: 5 },
  { order_id: 4, product_id: 3, quantity: 3 },
  // Distribuciones Casas (orders 5-8)
  { order_id: 5, product_id: 4, quantity: 4 },
  { order_id: 5, product_id: 6, quantity: 3 },
  { order_id: 6, product_id: 1, quantity: 5 },
  { order_id: 6, product_id: 2, quantity: 2 },
  { order_id: 7, product_id: 3, quantity: 4 },
  { order_id: 7, product_id: 5, quantity: 3 },
  { order_id: 8, product_id: 6, quantity: 4 },
  { order_id: 8, product_id: 4, quantity: 3 },
  // Comercial Ibérica (orders 9-12)
  { order_id: 9, product_id: 1, quantity: 3 },
  { order_id: 9, product_id: 2, quantity: 3 },
  { order_id: 10, product_id: 3, quantity: 4 },
  { order_id: 10, product_id: 4, quantity: 2 },
  { order_id: 11, product_id: 5, quantity: 3 },
  { order_id: 11, product_id: 6, quantity: 3 },
  { order_id: 12, product_id: 1, quantity: 4 },
  { order_id: 12, product_id: 2, quantity: 2 },
  // Almacenes del Sur (orders 13-16)
  { order_id: 13, product_id: 3, quantity: 3 },
  { order_id: 13, product_id: 4, quantity: 2 },
  { order_id: 14, product_id: 5, quantity: 3 },
  { order_id: 14, product_id: 6, quantity: 2 },
  { order_id: 15, product_id: 1, quantity: 3 },
  { order_id: 15, product_id: 2, quantity: 2 },
  { order_id: 16, product_id: 3, quantity: 3 },
  { order_id: 16, product_id: 4, quantity: 2 },
  // Industrias Bernal (orders 17-20)
  { order_id: 17, product_id: 1, quantity: 2 },
  { order_id: 17, product_id: 2, quantity: 2 },
  { order_id: 18, product_id: 3, quantity: 2 },
  { order_id: 18, product_id: 4, quantity: 2 },
  { order_id: 19, product_id: 5, quantity: 2 },
  { order_id: 19, product_id: 6, quantity: 2 },
  { order_id: 20, product_id: 1, quantity: 2 },
  { order_id: 20, product_id: 2, quantity: 2 },
  // Remaining Spanish (orders 21-42), 1 item each
  { order_id: 21, product_id: 1, quantity: 1 },
  { order_id: 22, product_id: 2, quantity: 1 },
  { order_id: 23, product_id: 3, quantity: 1 },
  { order_id: 24, product_id: 4, quantity: 1 },
  { order_id: 25, product_id: 5, quantity: 1 },
  { order_id: 26, product_id: 6, quantity: 1 },
  { order_id: 27, product_id: 1, quantity: 1 },
  { order_id: 28, product_id: 2, quantity: 1 },
  { order_id: 29, product_id: 3, quantity: 1 },
  { order_id: 30, product_id: 4, quantity: 1 },
  { order_id: 31, product_id: 5, quantity: 1 },
  { order_id: 32, product_id: 6, quantity: 1 },
  { order_id: 33, product_id: 1, quantity: 1 },
  { order_id: 34, product_id: 2, quantity: 1 },
  { order_id: 35, product_id: 3, quantity: 1 },
  { order_id: 36, product_id: 4, quantity: 1 },
  { order_id: 37, product_id: 5, quantity: 1 },
  { order_id: 38, product_id: 6, quantity: 1 },
  { order_id: 39, product_id: 1, quantity: 1 },
  { order_id: 40, product_id: 2, quantity: 1 },
  { order_id: 41, product_id: 3, quantity: 1 },
  { order_id: 42, product_id: 4, quantity: 1 },
  // French customers (orders 43-50), 1 item each
  { order_id: 43, product_id: 5, quantity: 1 },
  { order_id: 44, product_id: 6, quantity: 1 },
  { order_id: 45, product_id: 1, quantity: 1 },
  { order_id: 46, product_id: 2, quantity: 1 },
  { order_id: 47, product_id: 3, quantity: 1 },
  { order_id: 48, product_id: 4, quantity: 1 },
  { order_id: 49, product_id: 5, quantity: 1 },
  { order_id: 50, product_id: 6, quantity: 1 },
];
