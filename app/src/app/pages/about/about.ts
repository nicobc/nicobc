...
export class About {
  ...
  readonly closingParaBefore =
    'With machines, that precision is non-negotiable, but intent is invariably underspecified. Engineering is the work of clarifying and translating intent in the face of constraints. Implementation is where that translation is decided. Questions are where it starts. If you have one, ';
}
