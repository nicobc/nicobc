...
import { checkCapstoneStructure } from './challenge-validators';

// Parametrized test cases — one per CTE count.
// Analogous to @pytest.mark.parametrize: cases.forEach drives one `it` per row.
// More scenarios (uppercase columns, extra whitespace, etc.) added later.
